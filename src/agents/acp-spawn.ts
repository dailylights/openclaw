...
export { isSpawnAcpAcceptedResult } from "./acp-spawn-contract.js";
export type { SpawnAcpContext, SpawnAcpResult, SpawnAcpSandboxMode } from "./acp-spawn-contract.js";
...
export async function spawnAcpDirect(
  ...
  return {
    ...
    note: resolveAcpSpawnAcceptedNote(spawnMode),
  };
}
